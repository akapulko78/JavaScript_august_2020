...
// перемещение страницы по координатам относительно текущего положения. Здесь - на 200px вниз
scrollBy(0, 200);

// перемещение страницы по определенным координатам на странице. Здесь - в место равное 200px
scrollTo(0, 200);
